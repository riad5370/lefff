...
<div class="container-fluid py-1">
    <section class="product_details wow fadeInUp">
        ...
        <div class="text-center">
            <a href="{{route('contact')}}" type="button" class="btn btn-danger mb-5">Book Now</a>
          </div>
    </section>
    ...
    <section class="product_details ">
        ...
        <div class="text-center mb-5 wow fadeInUp" >
            ...
            <samp><button  href="{{route('contact')}}" type="button" class="btn btn-secondary ">Book Now</button></samp>    
          </div>
    </section>
